      ...
      <Row>
        ...
        <Col md="6">
          <ComponentCard title="Doughnut Chart">
            <Chart options={optionsdoughnut} series={seriesdoughnut} type="donut" height="300" />
          </ComponentCard>
        </Col>
        <Col md="6">
        ...
        <Col md="6">
          <ComponentCard title="3D Bubble Chart">
            <Chart options={optionsbubble} series={seriesbubble} type="bubble" height="280" />
          </ComponentCard>
        </Col>
        <Col md="6">
          <ComponentCard title="Scatter Chart">
            <Chart options={optionsscatter} series={seriesscatter} type="scatter" height="280" />
          </ComponentCard>
        </Col>
        <Col md="12">
          <ComponentCard title="Heat Map Chart">
            <Chart options={optionsheatmap} series={seriesheatmap} type="heatmap" height="350" />
          </ComponentCard>
        </Col>
        <Col md="6">
