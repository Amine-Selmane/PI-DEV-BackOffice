        ...
        {messages.map((msg) => (
          <ListGroupItem action key={msg.id} tag="a" href="/">
            <div className="d-flex align-items-center gap-3 py-2">
              ...
              <div className="col-9">
                <ListGroupItemHeading className="mb-0 fw-medium">{msg.title}</ListGroupItemHeading>
                <ListGroupItemText className="text-muted text-truncate d-block mb-0">{msg.desc}</ListGroupItemText>
